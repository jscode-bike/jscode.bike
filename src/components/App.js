...
const sample = {
  ...
  description: 'Write a function `fizzBuzz` that accepts an integer `n` and returns "fizz" if `n` is divisible by 3 and "buzz" if `n` is divisible by 5 and "fizzBuzz" if `n` is divisible by 3 and 5'
